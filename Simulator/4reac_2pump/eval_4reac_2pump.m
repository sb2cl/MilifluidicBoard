%% Simulation
sim('mdl_4reac_2pump','StopTime','100');
% save('data_4reac_2pump','out');
% save('data_4reac_2pump_diff_ref','out');

%% Evaluation
% load('data_4reac_2pump');
load('data_4reac_2pump_diff_ref');
...
subplot(2,1,2)
% plot actual OD
plot(out.tout(t_indices), out.actual_OD(t_indices,1));
grid on
hold on
plot(out.tout(t_indices), out.actual_OD(t_indices,2));
plot(out.tout(t_indices), out.actual_OD(t_indices,3));
plot(out.tout(t_indices), out.actual_OD(t_indices,4));
% plot OD reference
plot(out.tout(t_indices), out.OD_reference(t_indices,1));
plot(out.tout(t_indices), out.OD_reference(t_indices,2));
plot(out.tout(t_indices), out.OD_reference(t_indices,3));
plot(out.tout(t_indices), out.OD_reference(t_indices,4));
