...
% INPUT: u
%   u(1): F_in  (Input flow)  [mL/min]
%   u(2): F_out (Output flow) [mL/min]
...
%   y(5):  V    (Volume of liquid inside the biorreactor)       [mL]
...
switch flag
    ...
    case 1 % Derivatives
        ...
        %dV    (Volume of liquid inside the biorreactor)
        sys(3)= F_in - F_out;
